                ...
                <table class="datatable table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="{{base_url('emlak/ofis/'.$ofis->id.'/edit')}}" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i> Edit</a> <a href="{{base_url('emlak/ofis/'.$ofis->id.'/delete')}}" class="btn btn-danger btn-xs confirm"><i class="fa fa-trash-o"></i> Delete</a></td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
