...
@section('title')
Emlak Ofisi Duzenle: {{$ofis->ofis_adi}} | Emlak Ofisi Yönetimi | YönetimPaneli
@endsection
...
@section('breadcrumb')
      <div class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Emlak Ofisi Duzenle</li>
        </ol>
      </div> <!-- /.content-header -->
@endsection
...
@section('content')
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Emlak Ofisi Düzenle: {{$ofis->ofis_adi}}</h3>
        </div>
        <div class="box-body">

          <form id="validate-basic" action="{{base_url('emlak/ofis/'.$ofis->id)}}" method="post" data-validate="parsley" class="form parsley-form">

            <div class="form-group">
              <label for="ofis_adi">Ofis Adi</label>
              <input type="ofis_adi" id="ofis_adi" name="ofis_adi" class="form-control" data-parsley-trigger="change" data-required="true" value="{{$ofis->ofis_adi}}">
            </div>

            <hr>
            
            <h2>Ofis Yetkilileri</h2>
            <div class="form-group">
